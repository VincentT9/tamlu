    ...
    <>
      ...
      <QueryState isLoading={notifications.isLoading} error={notifications.error} empty={!notifications.data?.data.length} refetch={notifications.refetch}>
        <Stack spacing={1.5} sx={{ mb: 2 }}>
          <Paper variant="outlined" sx={{ p: 2.25, borderRadius: 2, borderColor: "var(--color-border)", bgcolor: "var(--color-surface)", boxShadow: "var(--shadow-surface)" }}>
            <Stack direction={{ xs: "column", md: "row" }} justifyContent="space-between" spacing={1}>
              <Box>
                <Typography fontWeight={800}>Trung tâm thông báo</Typography>
        ...
        <DataTableFrame label="Danh sách thông báo"><Table size="small"><TableHead><TableRow><TableCell>Tiêu đề</TableCell><TableCell>Loại</TableCell><TableCell>Ngày</TableCell><TableCell /></TableRow></TableHead><TableBody>
