...
const dashboardNav: DashboardNavItem[] = [
  ...
  { label: "Kho hàng", to: "/ops/inventory", roles: opsRoleAliases, icon: <Inventory2OutlinedIcon fontSize="small" /> },
  { label: "Quản lý phương tiện", to: "/ops/vehicles", roles: [ROLES.admin], icon: <LocalShippingOutlinedIcon fontSize="small" /> },
