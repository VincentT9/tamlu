...
const financialRoleAliasesMore = [ROLES.donor, ROLES.citizen, ...financialRoleAliases];
...
const dashboardNav: DashboardNavItem[] = [
  ...
  { label: "Chiến dịch", to: "/donor/campaigns", roles: financialRoleAliasesMore, icon: <CampaignOutlinedIcon fontSize="small" /> },
