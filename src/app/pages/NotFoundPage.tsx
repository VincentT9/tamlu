...
export function NotFoundPage() {
  return (
    <Stack spacing={2} alignItems="center" justifyContent="center" sx={{ minHeight: 520, px: 2 }}>
      <Paper variant="outlined" sx={{ width: "100%", maxWidth: 560, p: { xs: 3, md: 4 }, borderRadius: 4, textAlign: "center" }}>
        <Stack spacing={2} alignItems="center">
          <Box sx={{ display: "grid", placeItems: "center", width: 64, height: 64, borderRadius: 4, bgcolor: "primary.light", color: "primary.main", fontWeight: 900 }}>
            404
          </Box>
